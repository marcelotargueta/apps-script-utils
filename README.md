...
👉 [![](https://img.shields.io/badge/Copie_o_prompt__start.md-blueviolet.svg)](./prompts/prompt_start.md)

### 4. 🎨 Regras de UI (Opcional)

Se precisar de ajuda específica com sintaxe do Tailwind v4 ou Scriptlets:
👉 [![](https://img.shields.io/badge/Copie_o_prompt__ui__rules.md-blueviolet.svg)](./prompts/prompt_ui_rules.md)
